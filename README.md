...
Hey! You found my first GitHub project! My first GitHub project is a text-based fighting game!
...
You can download my C++, Makefile, and object oriented files to see a code template of what you text-based fighting game looks like for your guide.

To get started playing my text-bnased fighting game, download main.exe and open it with Windows Command Prompt.

# __WHAT THIS GAME INCLUDES:__
